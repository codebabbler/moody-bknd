...
const changePassword = asyncHandler(async (req: any, res) => {
...
const updateavatar = asyncHandler(async (req: any, res) => {
...
const updateCoverImage = asyncHandler(async (req: any, res) => {
